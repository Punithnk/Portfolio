      ...
      <div className="space-y-6 text-slate-700 dark:text-slate-300">
        <div>
          ...
          <ul className="list-disc ml-5 mt-2 text-sm">
            ...
            <li>Automated data validation tasks and created dashboards to surface defects, reduced manual verification time.</li>
        ...
        <div>
          ...
          <ul className="list-disc ml-5 mt-2 text-sm">
            <li>
              <strong>Taskify</strong> - Built a full-stack task manager (React frontend, Python APIs, MySQL); owned UI workflows and deployment;{' '}
              <a className="text-teal-600 underline" href="https://github.com/Punithnk/Taskify" target="_blank" rel="noreferrer">GitHub</a>.
            </li>
            <li>
