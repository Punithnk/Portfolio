      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 py-3 flex flex-col sm:flex-row sm:items-center gap-3">
        <div className="w-full flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-sky-500 to-cyan-400 flex items-center justify-center text-white font-semibold">
              PN
            </div>
            <div className="text-sm font-semibold text-slate-800 dark:text-slate-100">Punith N K</div>
          </div>
          ...
          <div className="flex items-center gap-2">
            ...
            <a className="hidden sm:inline-flex btn-ghost" href={resumeUrl} download>
              Resume
            </a>
          </div>
        </div>

        <div className="w-full sm:w-auto flex items-center gap-4 text-xs sm:text-sm text-slate-600 dark:text-slate-200 overflow-x-auto no-scrollbar">
          ...
          <a href="#education" className="hover:text-slate-900 dark:hover:text-white transition">Education</a>
